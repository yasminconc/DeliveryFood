  ...
  return (
    <div className="flex flex-col h-screen">
      <div className="flex flex-col items-center pt-12">
        ...
        <div className="flex items-center flex-col rounded shadow-xl border-white w-80 h-96">
          ...
          <div className=" mt-3 flex flex-col items-center gap-3 ">
            ...
            <p className="text-sm font-medium">
              dont have an account? <span className="font-bold cursor-pointer hover:text-slate-800">signup</span>
            </p>
          </div>
        </div>
      </div>
